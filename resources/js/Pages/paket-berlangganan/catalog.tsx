...
export default function Katalog({ produk }: Props) {
  ...
  return (
    <>
      <Head title="Katalog Paket Berlangganan" />
      ...
      <div className="min-h-screen bg-gray-50">
        ...
        <div className="bg-gradient-to-r from-slate-900 to-blue-900 text-white py-12">
          <div className="max-w-6xl mx-auto px-4">
            <h1 className="text-3xl font-extrabold">Katalog Paket Berlangganan</h1>
            <p className="text-slate-300 mt-2 text-sm">
              {list.length} paket tersedia — temukan yang terbaik untuk Anda 🚀
            </p>
          </div>
        </div>
